...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .csrf().disable()
                .authorizeRequests()
                .antMatchers("/", "/kartvy", "/testgetallroutes", "/testgetallfromdb", "/testgetroutefromdb/**", "/testgetpositionfromdb/**", "/testgetrouteandpositionfromdb/**", "/registrering", "/tur", "/style.css", "/index.js", "/map-route.js", "/mapview.js", "/dropdown-clickable.js", "/images/**").permitAll()
